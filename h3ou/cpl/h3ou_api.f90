...
!--------------------------------   public  ----------------------------------!
  ...
  public :: h3ou_set_interpolation_table   ! subroutine (my_comp, send_comp, send_grid, recv_comp, recv_grid, tag,
                                           !             send_index, recv_index, coef, coef_cos, coef_sin)
  ...
  public :: h3ou_inc_time                  ! subroutine (time_array, delta_t)
  ...
  public :: h3ou_put_data                  ! subroutine (data_name, data, data_vector)
  public :: h3ou_put_data_1d               ! subroutine (data_name, data, data_vector)
  public :: h3ou_put_data_25d              ! subroutine (data_name, data, data_vector)
  public :: h3ou_get_data                  ! subroutine (data_name, data, data_vector, is_recv_ok)
  public :: h3ou_get_data_1d               ! subroutine (data_name, data, data_vector, is_recv_ok)
  public :: h3ou_get_data_25d              ! subroutine (data_name, data, data_vector, is_recv_ok)
