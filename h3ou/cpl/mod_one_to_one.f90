!====================================================================================================
!> @brief
!> h3open_mp one to one ensemble module
!

module mod_one_to_one
  use mpi
...
!--------------------------------   public  ----------------------------------!
  ...
  public :: set_one_to_one_ensemble  ! subroutine (comp_name, num_of_ensemble)
...
subroutine set_one_to_one_ensemble(comp_name, num_of_ensemble)
  implicit none
...
end subroutine set_one_to_one_ensemble

!=======+=========+=========+=========+=========+=========+=========+=========+

end module mod_one_to_one
